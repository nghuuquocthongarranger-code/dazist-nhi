...
export const bodyStrength = {
  ...
  paragraphs: [
    ...
    "Tiết khí lúc sinh: sinh 15:10 ngày 13/06/2001, thuộc tiết Mang Chủng (tiết khí mở đầu tháng Ngọ, bắt đầu lúc 21:53 ngày 05/06/2001) và cách Hạ Chí — tiết khí kế tiếp, bắt đầu 14:37 ngày 21/06/2001 — còn 8 ngày, tức nằm ở khoảng giữa tiết Mang Chủng, chưa bước sang Hạ Chí. Sinh giữa tiết (không sát đầu hay cuối tháng) cho thấy đắc lệnh ở đây rất \"thuần\", không lẫn khí giao mùa từ tháng liền kề — củng cố thêm cho kết luận đắc lệnh vững chắc đã nêu ở trên, độc lập với cách tính theo tỉ trọng Thiên Can/Tàng Can.",
  ],
};
